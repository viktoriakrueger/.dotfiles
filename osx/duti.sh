...
# csv
duti -s com.vladbadea.csveditor .csv all

# qutebrowser
#duti -s org.qt-project.Qt.QtWebEngineCore .html all
...
duti -s org.videolan.vlc .aax all
duti -s org.videolan.vlc .aiff all
duti -s org.videolan.vlc .mpc all
duti -s org.videolan.vlc .toc all
